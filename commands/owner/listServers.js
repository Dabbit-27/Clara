...
exports.exec = (Bastion, message, args) => {
  ...
  message.channel.send({
    embed: {
      ...
      title: 'Server List',
      description: `Clara is connected to **${totalGuilds}** servers${Bastion.shard ? `, in Shard ${Bastion.shard.id}` : ''}.`,
      fields: fields,
      footer: {
...
exports.help = {
  name: 'listServers',
  description: 'Lists all Discord servers that Claea is connected to, in the current shard.',
  botPermission: '',
  userTextPermission: '',
  userVoicePermission: '',
