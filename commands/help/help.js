      ...
      message.channel.send({
        embed: {
          ...
          description: `To get the list of commands, type \`${message.guild.prefix[0]}commands\`.` +
                       ...
                       `\n\nNeed help or support with Clara Bot?\n${message.guild.id === '444814911823020032' ? 'Ask for helpin the <#267022940967665664> channel.' : 'Join [**Clara HQ**](https://discord.gg/4eMsYmx) for testing the commands or any help you need with the bot or maybe just for fun.\nhttps://discord.gg/4eMsYmx'}`,
          fields: [
            {
              name: 'Clara HQ Invite Link',
              value: 'https://discord.gg/4eMsYmx'
            },
            {
              name: 'Clara Bot Invite Link',
              value: `https://discordapp.com/oauth2/authorize?client_id=${Bastion.user.id}&scope=bot&permissions=8`
            }
          ],
          thumbnail: {
