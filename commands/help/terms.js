...
exports.exec = (Bastion, message) => {
  message.channel.send({
    embed: {
      ...
      title: 'Clara Bot - Terms of Service',
      url: '',
      description: '\nClara has access to the End User Data through the Discord API, but Clara does not collect, use and/or disclose End User Data except (a) as necessary to exercise your rights under this Agreement, (b) in accordance with Discord’s Privacy Policy.' +
        ...
        '\n\nBy using Clara you expressly agree to this Agreement. And by using Discord you expressly agree to Discord’s [Terms of Service](https://discordapp.com/terms), [Guidelines](https://discordapp.com/guidelines) and [Privacy Policy](https://discordapp.com/privacy).' +
...
exports.help = {
  name: 'terms',
  description: 'Read %clara%\'s Terms of Service.',
  botPermission: '',
  userTextPermission: '',
  userVoicePermission: '',
  usage: 'terms',
