...
module.exports = async Bastion => {
  try {
    ...
    if (!Bastion.shard || process.env.SHARDS_READY) {
      ...
      Bastion.log.console(COLOR`\n{gray </> with ❤ by The Clara Bot Team & Contributors}`);
      Bastion.log.console(COLOR`{gray Copyright (C) 2017-2018 The Clara Bot Project}`);
      ...
      Bastion.webhook.send('bastionLog', {
        ...
        footer: {
          ...
          text: `Clara v${Bastion.package.version}`
        },
        timestamp: new Date()
      });
    }
